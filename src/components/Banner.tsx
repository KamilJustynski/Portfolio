      ...
      <div className="flex flex-col gap-y-8 lg:mb-32 lg:flex-row lg:items-center lg:gap-x-12">
        <div className="flex-1 text-center font-secondary lg:text-left">
          ...
          >
            ...
            tylko przyciągają wzrok, ale także zapewniają użytkownikowi wygodne
            i płynne doświadczenie. Zawsze staram się dopasować projekt do
            indywidualnych potrzeb klienta, dbając o to, by efekt końcowy był
